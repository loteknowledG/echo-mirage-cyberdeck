...
import { createAccomplishment } from "@/lib/calyx/domains/career/career-service.server";
...
export async function POST(request: Request) {
  try {
    ...
    const accomplishment = await createAccomplishment(ownerId, body);
    return careerCreated(accomplishment);
  } catch (error) {

...
import { verifyCareerRecordFromInput } from "@/lib/calyx/domains/career/career-service.server";
...
export async function POST(request: Request) {
  try {
    ...
    await verifyCareerRecordFromInput(ownerId, body);
    return careerJson({ verified: true });
  } catch (error) {

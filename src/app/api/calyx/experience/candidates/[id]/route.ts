...
import { getExperienceCandidate } from "@/lib/calyx/domains/experience/experience-service.server";
...
export async function GET(_request: Request, context: RouteContext) {
  try {
    ...
    const candidate = await getExperienceCandidate(ownerId, id);
    return experienceJson({ candidate });
  } catch (error) {

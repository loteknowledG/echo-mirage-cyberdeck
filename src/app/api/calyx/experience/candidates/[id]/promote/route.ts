...
import { promoteExperienceCandidate } from "@/lib/calyx/domains/experience/experience-service.server";
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    const result = await promoteExperienceCandidate(ownerId, id, body);

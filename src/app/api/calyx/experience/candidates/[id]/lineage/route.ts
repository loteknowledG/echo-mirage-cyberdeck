...
import { getExperienceCandidateLineage } from "@/lib/calyx/domains/experience/experience-service.server";
...
export async function GET(_request: Request, context: RouteContext) {
  try {
    ...
    const lineage = await getExperienceCandidateLineage(ownerId, id);

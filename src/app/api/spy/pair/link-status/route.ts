...
import { checkEchoSpyLinkStatus } from "@/lib/server/spy-echo-pairing.server";
...
/** Mirage or PowerFist — poll whether Echo Spy session is still active. */
export async function POST(request: Request) {
  ...
  const result = await checkEchoSpyLinkStatus({
    echoNodeId,
    role,

...
import { MemoryMomentCard } from "@/components/voice-studio/memory-moment-card";
import { AsciiStartStopButton } from "@/components/voice-studio/ascii-start-stop-button";
import { DEFAULT_VSCODE_TTS_PROFILE_ID } from "@/lib/cursorTtsProfiles";
import { resolveVoiceProfile } from "@/lib/voice-profiles";

import { useMemo, useState } from "react";

export function VSCodeVoiceCard({

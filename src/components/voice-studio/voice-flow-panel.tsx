...
import { VSCodeVoiceCard } from "@/components/voice-studio/vscode-voice-card";
...
const VOICE_GRID_LAYOUT_STORAGE_KEY = "emc_voice_grid_layout_v1";
const VSCODE_VOICE_PROFILE_STORAGE_KEY = "emc_vscode_voice_profile_v1";
...
export function VoiceFlowPanel({ compact = false }: { compact?: boolean } = {}) {
